...
<p>Few days ago I discovered the [*OpenAI Gym* library](https://gym.openai.com/). *OpenAI Gym* is a bundle of standardized AI environments written in Python to benchmark the skills of AI programs and scripts, also known as agents.

All environments contained in the *OpenAI Gym* library follow the deep reinforcement learning paradigm</p>      
{: .text-justify}
