...
### CartPole.   
CartPole is an environment consisting on a cart and a pole *(what a surprise!)*   
![Figure2](/images/P2Figure2.jpg)
   
We control the cart by moving it to the right or the left so the pole, which is attached to the cart, will move as a consequence. The goal of the agents that *play* in this environment is to maintain the pole in equilibrium preventing it to reach a certain inclination.    
