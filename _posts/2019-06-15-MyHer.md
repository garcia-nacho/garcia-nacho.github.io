...
As you can imagine it is much more efficient to have 11 cores working in the same process that 1 core doing all the task, and indeed it divides the computing time by 10.
{: style="text-align: justify"}
