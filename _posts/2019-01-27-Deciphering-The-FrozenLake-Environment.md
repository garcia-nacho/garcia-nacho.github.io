...
Next, I tested an agent in which solving the episode was prioritized over avoiding the holes:
{: style="text-align: justify"}
...
There are three hyper-parameters that can be adjusted (manually or iteratively):
{: style="text-align: justify"}
