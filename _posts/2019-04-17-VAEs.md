...
I needed to find a less sparse way to represent the data in order to feed the model and I decided to format the data in a similar way to the output of getMidiNotes: constructing an array with 4 dimensions.
{: style="text-align: justify"} 
