...
On the internet, there are many posts and literature about VAE generating faces, hand-written digits or pictures of cats; however, the use of VAE to generate music is less commonly found and this is what I will try to implement in this post.
{: style="text-align: justify"}   
